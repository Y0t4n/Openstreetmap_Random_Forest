...
print(np.std(random_forest_macro_prec), np.std(random_forest_macro_rec), np.std(random_forest_macro_f1), np.std(random_forest_weighted_p    rec), np.std(random_forest_weighted_rec), np.std(random_forest_weighted_f1))
